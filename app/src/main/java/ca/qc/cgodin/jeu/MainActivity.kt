        ...
        playButton.setOnClickListener {
            ...
            try {
                ...
                if (balance >= bet) {
                    ...
                    val images = arrayOf(
                        R.drawable.img7, R.drawable.fsa, R.drawable.banane, R.drawable.berry, R.drawable.strawberry,
                        R.drawable.rubis, R.drawable.diamant, R.drawable.sacargent, R.drawable.peach, R.drawable.piece,
